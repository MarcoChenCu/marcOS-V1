            ...
            <div>
              <div class="mb-5 sm:mb-8">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  Ingresa las credenciales de usuario del sistema para ingresar
                </p>
              </div>
              <div>
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        id="user"
                        name="user"
                        placeholder="Nombre de usuario. Ejemplo: root"
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">
                Panel de gestión de servidores basada en Ubuntu Server.
              </p>
            </div>
          </div>
        </div>
  ...
  const handleSubmit = async () => {
    ...
    const apiURL = import.meta.env.VITE_API_URL      
      ...
      if (response.data.success) {
        ...
        notificationStore.add('error', 'Error al inciar sesión', 'Verifique sus credenciales.')
      }
    } catch (err) {      
      notificationStore.add('error', 'Error al inciar sesión', 'Verifique sus credenciales.')
    }
